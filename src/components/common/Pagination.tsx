...
const Pagination: React.FC<PaginationProps> = ({ pageCount, onPageChange, isMobile, selectedPage }) => {
  return (
    <div className="flex justify-center mt-6 mb-20 lg:mb-6">
      <ReactPaginate
        ...
        forcePage={selectedPage}  // Use forcePage to highlight the correct active page
